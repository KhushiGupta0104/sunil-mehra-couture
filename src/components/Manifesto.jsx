...
export default function Manifesto() {
    return (
        <section
            id="manifesto"
            className="relative bg-[var(--ink)] text-[var(--bone)] py-10 sm:py-12 lg:py-14 px-6 sm:px-12 lg:px-20 overflow-hidden"
            data-testid="manifesto-section"
        >
            <div className="grain" />
            <div className="relative z-10 max-w-[1200px] mx-auto text-center">
                <p className="eyebrow !text-[var(--champagne)] justify-center mb-5">
                    The House Manifesto
                </p>
